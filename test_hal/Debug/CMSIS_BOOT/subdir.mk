...
CMSIS_BOOT/%.o: ../CMSIS_BOOT/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -fno-builtin -Werror -Wall  -g -x assembler-with-cpp -DUSE_STDPERIPH_DRIVER -DSTM32F40XX -I"D:\projects\stm32f4\test_hal\CMSIS_BOOT" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
